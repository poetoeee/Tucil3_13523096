...
public class SolverNode implements Comparable<SolverNode> {
    ...
    public SolverNode(Board initialBoardState) {
    ...
    public SolverNode(Board boardState, SolverNode parent, Move moveThatLedToThisState, int gCost) {
